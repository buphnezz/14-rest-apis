...
(function (module) {
  ...
  adminView.initAdminPage = function (ctx, next) {
    ...
    $('#admin-form').on('submit', function(event) {
      ...
      // Answer: The token is not cleared out of local storage.  I do not agree with this structure, as a user of the same computer could find the token used by whoever last input their TOKEN.
