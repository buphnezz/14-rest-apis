...
(function(module) {
  ...
  //Answer: It is invoked in the book-view.js file.  The result from calling the API/Model is pass in as the 'book' argument. In this case, it represents the array of objects.
  ...
  // Answer: It is invoked in the book-view.js file at line 119.  This differs from the Book.find method because it is only searching for a single book object and not the entire array of all book objects.  
  Book.findOne = isbn =>
